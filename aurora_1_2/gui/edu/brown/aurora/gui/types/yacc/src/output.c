...
FILE *f;
  if (jflag)/*rwj*/
    ...
    fprintf(f,"   */\n");
    fprintf(f,"  public %sVal(String str, Object obj)\n",jclass_name);
    fprintf(f,"  {\n");
    fprintf(f,"    this.str = str;\n");
    fprintf(f,"    this.obj = obj;\n");
    fprintf(f,"  }\n");
    fprintf(f,"}\n");
    fclose(f);
    ...
    fprintf(code_file,"  yyval=new %sVal(null, null);\n",jclass_name);
    fprintf(code_file,"  yylval=new %sVal(null, null);\n",jclass_name);
    fprintf(code_file,"  valptr=-1;\n");
    fprintf(code_file,"}\n");
    ...
    fprintf(code_file,"{\n");
    fprintf(code_file,"  if (valptr<0)\n");
    fprintf(code_file,"    return new %sVal(null, null);\n",jclass_name);
    fprintf(code_file,"  return valstk[valptr--];\n");
    fprintf(code_file,"}\n");
    fprintf(code_file,"void val_drop(int cnt)\n");
    fprintf(code_file,"{\n");
