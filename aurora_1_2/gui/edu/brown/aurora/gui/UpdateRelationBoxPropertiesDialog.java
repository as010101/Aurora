...
/**
 * A class that implements a properties dialog for UpdateRelation boxes.  It constructs
 * the UpdateRelationbox-specific properties components for the properties dialog.
 *
 * @author Jeong-hyon Hwang (jhhwang@cs.brown.edu) and Robin Yan (rly@cs.brown.edu)
 * @version 1.0 04/10/2002
 */
public class UpdateRelationBoxPropertiesDialog extends UnaryBoxPropertiesDialog {
    ...
    /**
     * Constructs a new UpdateRelationBoxPropertiesDialog object.
     *
     * @param tm The typemanager contained in the GUI.
     * @param node The box node that this properties dialog is to be opened for.
     */
    public UpdateRelationBoxPropertiesDialog(UpdateRelationBoxNode node)
    {
        super(node);
        setTitle("UpdateRelation Box Properties Dialog");
    }
	...
	UpdateRelationBoxNode updateRelationNode = (UpdateRelationBoxNode)node;
