...
int DataType::Size(const datatype_t& type)
{
   switch(type.type)
   {
      case INTEGER:
...
void DataType::TypeCast(const datatype_t& type, double data, char* result)
{
   switch(type.type)
   {
      case INTEGER:
...
void DataType::outputData(const datatype_t& type, char* data, ostream& ostrm)
{
   switch(type.type)
   {
      case INTEGER:
...
void DataType::printData(const datatype_t& type, char* data)
{
   switch(type.type)
   {
      case INTEGER:
...
void DataType::printType(const datatype_t& type)
{
   switch(type.type)
   {
      case INTEGER:
